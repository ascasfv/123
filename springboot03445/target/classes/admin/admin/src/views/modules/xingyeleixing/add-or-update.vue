<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="产品名称" prop="xingyeleixing">
            <el-input v-model="ruleForm.xingyeleixing"
                      placeholder="产品名称" clearable :readonly="ro.xingyeleixing"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="产品名称" prop="xingyeleixing">
              <el-input v-model="ruleForm.xingyeleixing"
