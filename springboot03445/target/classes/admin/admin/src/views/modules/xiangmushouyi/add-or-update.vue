  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="收益金额" prop="fenpeijine">
            <el-input v-model="ruleForm.fenpeijine"
                      placeholder="收益金额" clearable :readonly="ro.fenpeijine"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="收益金额" prop="fenpeijine">
              <el-input v-model="ruleForm.fenpeijine"
                        placeholder="收益金额" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      addEditForm: {
        ...
        "addEditBoxColor": "rgba(251, 249, 249, 1)",
  ...
  methods: {
    ...
    init(id, type) {
      ...
      this.fenpeileixingOptions = "ZH银行,WM信托,AJ银行,XW信托".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
