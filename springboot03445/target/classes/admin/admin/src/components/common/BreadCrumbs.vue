<template>
  <el-breadcrumb class="app-breadcrumb" separator="L"
                 style="height:50px;backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:0px;borderStyle:dotted solid double dashed;borderColor:rgba(40, 36, 36, 1);">
